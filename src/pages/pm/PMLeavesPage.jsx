...
const PMLeavesPage = () => {
    ...
    const myProjectIds = new Set(scopedProjects.map((project) => project.id));
    ...
    const approveMutation = useMutation({
        ...
        onSuccess: () => { queryClient.invalidateQueries({ queryKey: ['leaves'] }); toast.success('Leave approved and synced to Razorpay'); },
        onError: (err) => {
